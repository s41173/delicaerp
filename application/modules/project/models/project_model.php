...
class Project_model extends CI_Model
{
    ...
    {
        $this->db->select('project.id, project.no, project.name, customer.prefix, customer.name, project.dates, project.location,
    ...
    {
       $this->db->select('id, no, name, customer, dates, location, desc, status, staff, log');
       $this->db->where('id', $uid);
       return $this->db->get($this->table);
    }
    
    function get_project_by_no($uid)
    {
       $this->db->select('id, no, name, customer, dates, location, desc, status, staff, log');
...
//    =========================================  REPORT  =================================================================
    ...
    {
        $this->db->select('project.id, project.no, project.name, customer.prefix, customer.name as customer, project.dates, project.location,
                           project.desc, project.status, project.staff, project.log');
