        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Location', datafield: 'Location', width: 70, cellsalign: 'left' },
				  { text: 'Description', datafield: 'Description', width: 120, cellsalign: 'left'},
				  { text: 'Status', datafield: 'Status', width: 120, cellsalign: 'left'}
                ]
            });
			...
			$("#bexport").click(function() {
				...
				var type = $("#crtype").val();	
				if (type == 0){ $("#jqxgrid").jqxGrid('exportdata', 'html', 'Project-Summary'); }
				else if (type == 1){ $("#jqxgrid").jqxGrid('exportdata', 'xls', 'Project-Summary'); }
				else if (type == 2){ $("#jqxgrid").jqxGrid('exportdata', 'pdf', 'Project-Summary'); }
				else if (type == 3){ $("#jqxgrid").jqxGrid('exportdata', 'csv', 'Project-Summary'); }
			});
			...
			{
				var site = "<?php echo site_url('project/invoice/');?>";
				window.open(site+"/"+val+"/non", "", "width=800, height=600"); 
				//alert(site+"/"+val);
			}
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Project - Report </h4>
	   </div>
	</center>
...
<thead>
<tr>
<th> No </th> <th> Date </th> <th> Order No </th> <th> Customer </th> <th> Project </th> <th> Location </th> <th> Description </th> <th> Status </th>
</tr>
</thead>
...
<?php 
  ...
  function approval($val){ if ($val == 0){ return 'On - Progress'; }else { return 'Finished'; } }
  ...
  if ($aps)
  {
    ...
    {	
       ...
       <tr> 
           ...
           <td class=\"strongs\"> PRJ-00".$ap->no."</td> 
           <td class=\"strongs\">".$ap->customer."</td> 
           <td class=\"strongs\">".$ap->name."</td>
           <td class=\"strongs\">".$ap->location."</td>
           <td class=\"strongs\">".$ap->desc."</td>
           <td class=\"strongs\">".approval($ap->status)."</td> 
       </tr>";
       $i++;
    }
  }  
