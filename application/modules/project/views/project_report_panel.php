...
<div id="webadmin">
	...
	<fieldset class="field"> <legend> Project - Report </legend>
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>

			<tr>	
			<td> <label for="tname"> Customer </label> </td> <td>:</td>
			<td> <input type="text" readonly="readonly" name="tcust" id="tcust" size="25" title="Customer" /> 
            ...
            <tr> <td> <label for="cacc"> Status </label> </td> <td>:</td> <td>  
...
<!--                <option value="2"> Category </option>
                <option value="3"> Category Pivot Table </option>-->
			 </select> &nbsp; <br /> </td>
			</tr>
