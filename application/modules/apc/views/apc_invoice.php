...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Transcode </td> <td>:</td> <td> DJC-00<?php echo $pono; ?> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> No </th>  <th> Description </th> <th> Staff </th> <th> Code </th> <th> Amount </th> <th> Signature </th> </tr>
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> Director </td> <td> Accounting </td> <td> Kasir <br> (<?php echo $user; ?>) </td> <td> (________________) </td> </tr>
			</table>
		</div>
