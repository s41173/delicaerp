...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" >
				<table>
                    ...
                    <tr>	
                    <td> <label for="ctype"> Project </label> </td> <td>:</td>
                    <td> <?php $js = 'class="required"'; echo form_dropdown('cproject', $project, isset($default['project']) ? $default['project'] : '', $js); ?> &nbsp; <br /> </td>
                    </tr>
                    ...
                    <td>  
                     <select name="ctype">
                        ...
                        <option value="4"> Project Summary </option>
                     </select> &nbsp; <br /> </td>
                    </tr>
