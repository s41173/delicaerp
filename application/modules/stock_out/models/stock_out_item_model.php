...
class Stock_out_item_model extends CI_Model
{
    ...
    {
        $this->db->select('id, stock_out, product, qty, price, desc, staff');
    ...
    function report($po)
    {
        $this->db->select("$this->table.id, $this->table.stock_out, $this->table.product as pid, product.name as product, product.unit, product.warehouse_id, $this->table.qty, $this->table.price, $this->table.desc, $this->table.staff");
