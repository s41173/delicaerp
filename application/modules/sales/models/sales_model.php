...
class Sales_model extends CI_Model
{
    ...
    {
        $this->db->select('sales.id, sales.no, sales.invno, sales.type, sales.contract_no, sales.dates, sales.docno, customer.prefix, customer.name, sales.user, sales.status,
                           sales.total, sales.p2, sales.costs, sales.notes, sales.currency, sales.approved');
    ...
    {
        $this->db->select('sales.id, sales.no, sales.invno, sales.type, sales.contract_no, sales.dates, sales.docno, customer.prefix, customer.name, sales.user, sales.status,
                           sales.total, sales.p2, sales.notes, sales.currency, sales.approved');
    ...
    function counter_tax($type,$year)
    {
    ...
    {
        $this->db->select('sales.id, sales.no, sales.invno, sales.type, sales.contract_no, sales.dates, sales.docno, sales.customer, customer.prefix, customer.name, customer.address, customer.phone1, customer.phone2, sales.currency, sales.user, sales.log,
                           sales.status, sales.tax, sales.p1, sales.p2, sales.total, sales.notes, sales.desc, sales.discount_desc,
                           sales.shipping_date,sales.costs, sales.discount, sales.work_cost, sales.work_notes, sales.tax_serial, sales.tax_notes, sales.approved');
    ...
    {
        $this->db->select('sales.id, sales.no, sales.invno, sales.type, sales.contract_no, sales.dates, sales.docno, sales.customer, customer.prefix, customer.name, customer.address, customer.phone1, customer.phone2,
                           ...
                           sales.costs, sales.discount, sales.work_cost, sales.work_notes, sales.tax_serial, sales.tax_notes, sales.approved');
...
//        $this->db->where('YEAR(dates)', $year);
    ...
    function valid_tax_no($no,$type,$year)
    {
        $this->db->where('invno', $no);
        $this->db->where('type', $type);
        $this->db->where('YEAR(dates)', $year);
        $query = $this->db->get($this->table)->num_rows();
        if($query > 0) { return FALSE; } else { return TRUE; }
...
//    =========================================  REPORT  =================================================================
    ...
    {
        $this->db->select('sales.id, sales.no, sales.invno, sales.type, sales.contract_no, sales.dates, sales.docno, customer.prefix, customer.name, customer.address, customer.phone1, customer.phone2,
