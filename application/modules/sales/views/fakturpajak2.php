...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px; border:1px solid #000;">
	...
	<div class="bigrow">
		<table>
			...
			<tr> <td> Alamat </td> <td>:</td> <td> <b style="text-transform:uppercase;"> Jl. Medan - Binjai Km. 9,1 No. 8 Lalang - Sunggal, Deli Serdang <br> Sumatera Utara - 20127 </b> </td> </tr>
...
<!-- free box -->
	...
	<div class="bigrow1"> 
		...
		<p style="padding:20px 0px 0 145px; font-size:12px; font-weight:bold; float:left;"> Medan, tanggal : &nbsp; <?php echo $fakdate; ?> </p> <br>
