...
<div id="container">
	...
	<div id="logobox"> <img id="logo" align="middle" width="250" height="102" src="<?php echo base_url("images/property").'/delica_logo.png'; ?>"> </div>
    <div id="addressbox">
 		<p id="logotext"> 
        <b> Showroom : </b> <br>
		  <?php echo $paddress; ?> <br> Kotamadya Medan - <?php echo $p_zip; ?> &nbsp; Telp. (061) 80026062 <br>
		  E-Mail : info@delicaindonesia.com <br> Website : www.delicaindonesia.com
		</p>
		<p style="float:right; margin:0 0 10px 0px; padding:0px 5px 0 5px; font-weight:bold;"> NPWP : <?php echo $p_npwp; ?> </p>
    </div>
	...
	<div id="content">
		...
		<table class="tab1" border="0">
			<tr> <td> <b> Type. </b> </td> <td><p>:</p></td> <td> <p> <?php echo $type.' / 00'.$taxno; ?> </p> </td>  </tr>
	...
	<tr> <td> <p> Size </p> </td> <td><p>:</p></td> <td> <p> <?php echo $price ?> ,- </p></td> 
	...
	<tr> <td> <p> VAT (Tax) </p> </td> <td><p>:</p></td> <td><p> </p></td> <td><p>= <?php echo $symbol; ?></p></td> 
	...
	<tr> <td>  </td> <td></td> <td align="right"><p> Total </p></td> <td><p>= <?php echo $symbol; ?></p></td> 
        ...
        <p style="font-style:italic"> Log : <?php echo $this->session->userdata('log'); ?> / <?php echo $user; ?> </p>
        <p style="font-size:8pt; font-weight:bold;"> Pembayaran Di Lakukan Melalui Transfer : <br> Bank Permata  An: PT.DELICA INDONESIA / 800-200-1366 <br> Bank BCA  An: JIMMY / 825-016-9966 <br> Bank Permata  An: JIMMY / 800-101-7927
        </p>
        </div>
		<div style="width:150px; border:0px solid #000; margin:0px 0 0 20px; float:left;">
			<p style="margin:0; padding:15px 0 0 0;"> (...............................................) <br> &nbsp; &nbsp; &nbsp; <b> PT. Delica Indonesia </b> </p>
		</div> 
