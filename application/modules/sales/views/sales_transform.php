	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
				<table>
                	...
                	<tr> 
						...
						<td> <input type="text" name="ttype" id="ttype" size="3" maxlength="5" readonly
                             value="<?php echo set_value('ttype', isset($default['type']) ? $default['type'] : ''); ?>" />
                             &nbsp;
                             <input type="text" name="ttaxno" id="ttaxno" size="3" maxlength="5" readonly
                             value="<?php echo set_value('ttaxno', isset($default['taxno']) ? $default['taxno'] : ''); ?>" />
                        </td>
					</tr>
