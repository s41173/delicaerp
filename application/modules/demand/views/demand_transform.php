		...
		<table>
			<tr>				
				<td> <label for="tproduct"> Product </label>  <br />
				     <input type="text" class="required" readonly name="tproduct" id="tproduct" size="25" title="Name" />
				...
				<td> <label for="tvendor"> Vendor </label> <br>
				     <input type="text" class="required" readonly name="tvendor" id="tcust" size="20" title="Name" /> &nbsp; 
