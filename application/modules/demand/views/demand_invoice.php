...
<div id="container">
	...
	<div id="titbox"> 
		<p style="padding:0; margin:0 0 0 6.5cm; font-weight:bold; font-size:1.3em; text-align:left;"> FORMULIR PERMINTAAN BARANG </p>
	</div>
			...
			foreach ($items as $res)
			{
				echo "
				 ...
				 <tr> 
					...
					<td align=\"center\" class=\"desc\">".tglin($res->demand_date)."</td>
