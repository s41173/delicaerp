...
<style media="all">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
			...
			$('#jqxgrid').jqxGrid({ pagesizeoptions: ['25', '50', '100', '200', '300', '1000']}); 
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Product Demand - Category Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   ...
		   <thead>
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> SKU </th> <th> Product </th> <th> Qty </th> <th> Project Desc </th> <th> Staff </th> 
		   </tr>
           </thead>
			  ...
			  if ($reports)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\"> PRO-00".$res->pid."</td>
