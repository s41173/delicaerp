    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
          ...
          { text: 'No', dataField: 'No', width: 50 },
				  ...
				  { text: 'Qty', datafield: 'Qty', width: 150, cellsalign: 'center', cellsformat: 'number', aggregates: ['sum'] },
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Purchase Request - Category Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   ...
		   <thead>
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Type </th> <th> SKU </th> <th> Product </th> <th> Qty </th> <th> Project Desc </th> <th> Staff </th>
           <th> Status </th>
		   </tr>
       </thead>
		     ...
		     $i=1;
			  if ($reports)
			  {
				  function product($pid,$type)
				  {
					...
					function sku($pid)
					{
						if ($pid > 0){ return 'PRO-00'.$pid; }else { return '-'; }
					}

				  function realization($val){ if ($val == 0){ return 'N'; }else { return 'Y : '; } }
				...
				foreach ($reports as $res)
				{
				   ...
				   <tr>
				    <td class=\"strongs\">".$i."</td>
					   ...
					   <td class=\"strongs\">".sku($res->product)."</td>
					   <td class=\"strongs\">".product($res->product,$res->type)."</td>
   					 <td class=\"strongs\">".$res->qty."</td>
					   <td class=\"strongs\" align=\"center\">".$res->desc."</td>
					   <td class=\"strongs\" align=\"center\">".$res->user."</td>
					   <td class=\"strongs\" align=\"center\">".strtoupper($res->status)."</td>
				   </tr>";
				   $i++;
				}
			 }
