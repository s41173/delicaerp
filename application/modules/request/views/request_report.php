    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            { name: "No", type: "string" },
						...
						{ name: "Realization Date", type: "string" }
                    ]
                };
          ...
          { text: 'No', dataField: 'No', width: 50 },
				  ...
				  { text: 'Project Desc', dataField: 'Project Desc' },
				  { text: 'Staff', dataField: 'Staff', width : 150 },
				  { text: 'User', dataField: 'User', width : 150 },
				  { text: 'Realization', dataField: 'Realization', width: 100 },
				  { text: 'Realization Date', dataField: 'Realization Date', width: 150 }
                ]
            });

			$('#jqxgrid').jqxGrid({ pagesizeoptions: ['250', '500', '1000', '2000', '3000', '5000']});
			...
			{
				var site = "<?php echo site_url('request/print_invoice/');?>";
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:260px;">
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Purchase Request - Summary Report </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   ...
		   <thead>
		   <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Type </th> <th> Project Desc </th> <th> Staff </th> <th> User </th>
         <th> Realization </th> <th> Realization Date </th>
		   </tr>
       </thead>
		  ...
		  <?php
		     ...
		     $i=1;
			  if ($reports)
			  {
				...
				function realizations($val){ if ($val == 0){ return 'N'; }else { return 'Y'; } }

				function users($val)
				{
					$ad = new Admin_lib();
					return $ad->get_username($val);
				}
				...
				foreach ($reports as $res)
				{
				   ...
				   <tr>
					   ...
					   <td class=\"strongs\"> PR-00".$res->no."</td>
						 <td class=\"strongs\">".strtoupper($res->type)."</td>
					   <td class=\"strongs\" align=\"center\">".$res->desc."</td>
					   <td class=\"strongs\" align=\"center\">".$res->supervisor."</td>
					   <td class=\"strongs\" align=\"center\">".users($res->user)."</td>
					   <td class=\"strongs\" align=\"center\">".realizations($res->realization)."</td>
					   <td class=\"strongs\" align=\"center\">".tglin($res->realization_date)."</td>
				   </tr>";
				   $i++;
				}
			 }
