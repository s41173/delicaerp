	...
	<form name="modul_form" class="myform" id="ajaxform" method="post" action="<?php echo $form_action; ?>">
	     ...
	     <td> <input type="text" class="required" readonly name="tno" size="4" title="Name" value="<?php echo isset($code) ? $code : ''; ?>" /> &nbsp; <br /> </td>
					...
					<tr>
						...
						<td> <input type="text" class="required" readonly name="tsales" id="titem" size="5" title="Transaction Code"
					...
					<tr>
					    ...
					    <td> <input type="text" readonly name="ttotal" id="ttotal" size="15" title="Total"
					...
					<tr>
					    ...
					    <td> <input type="text" readonly name="tdp" id="tdp" size="15" title="DP"
						     value="<?php echo set_value('tdp', isset($default['dp']) ? $default['dp'] : ''); ?>" /> &nbsp; <br /> </td>
					</tr>
                    
                    <tr>
						<td> <label for="tamount"> Amount </label> </td>  <td>:</td>
					    <td> <input type="text" readonly name="tamount" id="tamount" size="15" title="Amount"
