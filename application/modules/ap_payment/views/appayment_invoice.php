...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> CASH OUT INVOICE </h2> <div style="clear:both; "></div> 
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Transcode </td> <td>:</td> <td> CD-0<?php echo $pono; ?> </td> </tr>
	...
	<div style="margin:3px 0 0 0; border-bottom:0px dotted #000;">
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						...
						<td class=\"right\"> ".number_format($res->amount+$res->discount,2)." </td>
						<td class=\"right\"> ".number_format($res->discount,2)." </td> 
						<td class=\"right\"> ".number_format($res->amount,2)." </td>  
					 </tr>
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> Manager </td> <td> Accounting </td> <td> Kasir </td> <td> ___________________ </td> </tr>
			</table>
		</div>
