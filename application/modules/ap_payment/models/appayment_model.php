...
class Appayment_model extends CI_Model
{
    ...
    {
        $this->db->select('ap_payment.id, ap_payment.no, ap_payment.tax, ap_payment.check_no, ap_payment.due, ap_payment.dates, vendor.prefix, vendor.name, ap_payment.user,
    ...
    {
        $this->db->select('ap_payment.id, ap_payment.no, ap_payment.tax, ap_payment.docno, ap_payment.due, ap_payment.check_no, ap_payment.dates, vendor.prefix, vendor.name, ap_payment.user,
                           ap_payment.amount, ap_payment.over, ap_payment.acc, ap_payment.currency, ap_payment.approved');
    ...
    {
        $this->db->select('ap_payment.id, ap_payment.no, ap_payment.tax, ap_payment.docno, ap_payment.check_no, ap_payment.post_dated, ap_payment.account, ap_payment.due,
    ...
    {
        $this->db->select('ap_payment.id, ap_payment.no, ap_payment.tax, ap_payment.docno, ap_payment.check_no, ap_payment.post_dated, ap_payment.account, ap_payment.due, ap_payment.vendor,
                           ap_payment.dates, vendor.prefix, vendor.name, ap_payment.user, ap_payment.discount, ap_payment.late, ap_payment.credit_over, ap_payment.over, ap_payment.over_stts,
                           ap_payment.amount, ap_payment.acc, ap_payment.rate, ap_payment.currency, ap_payment.approved');
    ...
    {
        $this->db->select('ap_payment.id, ap_payment.no, ap_payment.tax, ap_payment.docno, ap_payment.check_no, ap_payment.post_dated, ap_payment.dates, vendor.prefix, vendor.name, ap_payment.user,
