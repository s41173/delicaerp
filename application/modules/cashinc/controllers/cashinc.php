    ...
    function delete($uid,$po=null)
    {
        ...
        { 
           if ($val->approved == 1)
           {
             ...
             $this->ledger->remove($this->input->post('tdate'), "CR-00".$po);
             $val->approved = 0;
             $val->save();
...
//    ==========================================================================================
	...
	// Form validation
        ...
        if ($this->form_validation->run($this) == TRUE && $this->valid_confirmation($jid) == TRUE)
        {
            ...
            // ledger
            $this->ledger->remove($this->input->post('tdate'), "CR-00".$this->model->no);
            $this->ledger->add($this->get_acc_type($this->input->post('cacc')), "CR-00".$this->model->no, $this->input->post('ccurrency'), $this->input->post('tdate'), $this->model->amount, 0);
