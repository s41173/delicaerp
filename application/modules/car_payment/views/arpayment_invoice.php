...
<title> AR Payment - CR-00000<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center; text-decoration:underline;"> CASH - IN </h2> 
	...
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
			...
			<tr> <td> </td> <td> </td> <td> <?php echo $ven_bank; ?> </td> </tr>
   			<tr> <td> Check No </td> <td>:</td> <td> <?php echo $docno; ?> </td> </tr>
		</table>
	</div>
	
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Transcode </td> <td>:</td> <td>CCR-0<?php echo $pono; ?> </td> </tr>
	...
	<div style="margin:10px 0 0 0; border-bottom:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> No </th>  <th> Description </th> <th> Amount </th> <th> Discount </th> <th> Cost </th> <th> Balance </th> </tr>
			...
			if ($items)
			{
				...
				foreach ($items as $res)
				{
					echo "
					 ...
					 <tr> 
						<td> ".$i." </td>
						<td class=\"left\"> ".$res->code."-0".$res->no." - ".$res->notes." &nbsp; - &nbsp; ".tgleng($res->dates)." </td> 
						<td class=\"right\"> ".number_format($res->amount+$res->cost+$res->discount)." </td>
		 ...
		 <tr> <td></td> <td class="right"> </td> <td colspan="3" class="right"> <b> Total : </b> </td> <td class="right"> <?php echo $amount; ?> </td> </tr>
		...
		<style>
			...
			<table border="0" class="sig">
				<tr> <td> Manager </td> <td> Accounting </td> <td> ___________________ </td> <td> ___________________ </td> </tr>
			</table>
		</div>
