        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Transcode', dataField: 'Transcode', width : 200 },
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">	
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> AR - Payment Report Transactions </h4>
	   </div>
	</center>
	...
	<div style="width:100%; border:0px solid brown; margin-top:20px; border-bottom:1px dotted #000000; ">
		...
		<table id="table" border="0" width="100%">
		   <thead>
           <tr>
 	       <th> No </th> <th> Date </th> <th> Code </th> <th> Customer </th> <th> Transcode </th> <th> Balance </th> 
		   </tr>
           </thead>
			  ...
			  if ($reports1)
			  {
				...
				{	
				   ...
				   <tr> 
					   ...
					   <td class=\"strongs\">CSO-0".$res->no."</td> 
