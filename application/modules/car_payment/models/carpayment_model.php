...
class Carpayment_model extends CI_Model
{
    ...
    {
        $this->db->select('car_payment.id, car_payment.no, car_payment.docno, car_payment.check_no, car_payment.account, car_payment.due,
                           car_payment.dates, customer.prefix, customer.name, car_payment.user, car_payment.post_dated, car_payment.post_dated_stts,
                           car_payment.discount, car_payment.cost, car_payment.late, car_payment.amount, car_payment.acc, car_payment.currency, car_payment.approved');
    ...
    {
        $this->db->select('car_payment.id, car_payment.no, car_payment.docno, car_payment.check_no, car_payment.account, car_payment.due, car_payment.customer,
                           car_payment.dates, customer.prefix, customer.name, car_payment.user, car_payment.post_dated, car_payment.post_dated_stts,
                           car_payment.discount, car_payment.cost, car_payment.late, car_payment.amount, car_payment.acc, car_payment.currency, car_payment.approved');
    ...
    {
        $this->db->select('car_payment.id, car_payment.no, car_payment.docno, car_payment.check_no, car_payment.dates, customer.prefix, customer.name, car_payment.user,
                           car_payment.post_dated, car_payment.post_dated_stts,
                           car_payment.discount, car_payment.late, car_payment.cost, car_payment.amount, car_payment.account, car_payment.currency, car_payment.approved, car_payment.log');
