...
//        $this->db->where('stock_in.approved', 1);
    ...
    {
        $this->db->select('purchase.id, purchase.no, purchase.request, purchase.vendor, purchase.dates, purchase.acc, purchase.docno, vendor.prefix, vendor.name, purchase.currency, purchase.user, purchase.log,
    ...
    {
        $this->db->select('purchase.id, purchase.no, purchase.request, purchase.vendor, purchase.dates, purchase.acc, purchase.docno, vendor.prefix, vendor.name, vendor.address, vendor.phone1, vendor.phone2,
