...
<style media="all">
	...
	#logo { margin:0 10px 5px 120px; float:left; border:0px solid red;}
	#logotext{ font-size:1em; text-align:center; margin:0px 0 0 0px; }
...
<div style="width:20.5cm; font-family:Arial, Helvetica, sans-serif; font-size:12px; border:0px solid red;">
	...
	<div style="border:0px solid #000; width:11.5cm; float:left;">
		<img id="logo" align="middle" width="150" src="<?php echo isset($logo) ? $logo : ''; ?>"> <div class="clear"></div>
		<p id="logotext"> 
