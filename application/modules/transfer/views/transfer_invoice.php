...
<div style="width:750px; height:7cm; font-family:Arial, Helvetica, sans-serif; font-size:12px; border:1px solid #000;"> 
    ...
    <table border="0" class="sig">
        <tr> <td> Approved By : </td> <td> Review By : </td> <td> Paid By : </td> </tr>
    </table> <br> <br> <br> <br> <br> 
    
    <table border="0" class="sig">
        <tr> <td> Manager </td> <td> Accounting </td> <td> <br> (_______________) </td> </tr>
    </table>
    <br>
	<div class="clear"></div>
