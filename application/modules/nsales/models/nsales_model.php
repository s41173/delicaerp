...
class Nsales_model extends CI_Model
{
    ...
    {
        $this->db->select('nsales.id, nsales.no, nsales.dates, nsales.docno, customer.prefix, customer.name, nsales.user, nsales.status,
    ...
    {
        $this->db->select('nsales.id, nsales.no, nsales.dates, nsales.docno, nsales.customer, customer.prefix, customer.name, nsales.currency, nsales.user, nsales.log,
    ...
    {
        $this->db->select('nsales.id, nsales.no, nsales.dates, nsales.docno, nsales.customer, customer.prefix, customer.name, customer.address, customer.phone1, customer.phone2,
...
//    =========================================  REPORT  =================================================================
    ...
    {
        $this->db->select('nsales.id, nsales.no, nsales.dates, nsales.docno, customer.prefix, customer.name, customer.address, customer.phone1, customer.phone2,
