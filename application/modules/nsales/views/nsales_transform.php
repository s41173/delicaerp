	...
	<fieldset class="field" style="float:left; margin-left:15px;"> <legend> Payment Details </legend>
		...
		<table>
			...
			<tr>
				...
				<td><input type="text" id="ttax" name="ttax" disabled="disabled" readonly="readonly" size="10" title="Total Tax" 
			...
			<tr>
				...
				<td><input type="text" id="ttotaltax" disabled="disabled" name="ttotaltax" readonly="readonly" size="10" title="After Total Tax" 
