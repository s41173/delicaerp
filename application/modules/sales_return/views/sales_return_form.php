...
<div id="webadmin">
    ...
    <form method="get">
    <tr> <td> <label for="tpo"> Currency </label> </td> <td>:</td>
         <td> <?php $js = 'class="required" onchange="this.form.submit();"'; echo form_dropdown('ccurrency', $currency, isset($default['currency']) ? $default['currency'] : '', $js); ?> &nbsp; <br /> </td>
     </tr>
    </form>
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" >
                    ...
                    <tr> 
						...
						<?php echo anchor_popup(site_url("csales/get_list/".$default['currency']."/null/1"), '[ ... ]', $atts1); ?>
					</tr>
