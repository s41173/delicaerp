...
<title> Sales Return - SR-00<?php echo isset($pono) ? $pono : ''; ?></title>
<style media="all">
...
<div style="width:750px; font-family:Arial, Helvetica, sans-serif; font-size:12px;"> 
	...
	<h2 style="font-size:18px; font-weight:normal; text-align:center;"> SALES RETURN </h2> 
    <div style="clear:both; "></div> 
	
	<div style="width:350px; border:0px solid #000; float:left;">
		<table style="font-size:11px;">
 		    <tr> <td> Paid To </td> <td>:</td> <td> <?php echo $customer; ?> </td> </tr>
	...
	<div style="width:200px; border:0px solid red; float:right;">
		<table style="font-size:11px;">
			<tr> <td> Transcode </td> <td>:</td> <td>SR-00<?php echo $pono; ?> </td> </tr>
	...
	<div style="margin:10px 0 0 0; border-bottom:0px dotted #000;">
		...
		<table class="product">
		 ...
		 <tr> <th> No </th> <th> Product </th> <th> Qty </th> <th> Amount </th> <th> Tax </th> <th> Balance </th> </tr>
         ...
         <tr> <td></td> <td class="right"> </td> <td colspan="3" class="right"> <b> Cost : </b> </td> <td class="right"> <?php echo number_format($cost); ?> </td> </tr>
		 <tr> <td></td> <td class="right"> </td> <td colspan="3" class="right"> <b> Total Balance : </b> </td> <td class="right"> <b> <?php echo number_format($balance); ?> </b> </td> </tr>
