...
class Sales_return_model extends CI_Model
{
    ...
    {
        $this->db->select('sales_return.id, sales_return.no, sales_return.sales, sales_return.dates, sales_return.currency, sales_return.docno, sales_return.user,
                           sales_return.total, sales_return.cash, sales_return.balance, sales_return.costs, sales_return.notes, sales_return.approved');
    ...
    function get_sales_return_list($currency=null,$customer=null,$st=0)
    {
        $this->db->select('sales_return.id, sales_return.no, sales_return.sales, sales_return.dates, sales_return.currency, sales_return.docno, sales_return.user, sales_return.status,
        ...
        $this->db->where('sales_return.status', $st);
    ...
    {
        $this->db->select('sales_return.id, sales_return.no, sales_return.sales, sales_return.dates, sales_return.currency, sales_return.docno, sales_return.user, sales_return.log,
                           sales_return.tax, sales_return.customer, sales_return.balance, sales_return.total, sales_return.notes, sales_return.account,
    ...
    {
        $this->db->select('sales_return.id, sales_return.no, sales_return.sales, sales_return.dates, sales_return.currency, sales_return.docno,
                           sales_return.user, sales_return.log, sales_return.account,
                           sales_return.tax, sales_return.customer, sales_return.balance, sales_return.total, sales_return.notes,
                           sales_return.costs, sales_return.cash, sales_return.approved');
...
//    =========================================  REPORT  =================================================================
    ...
    {
        $this->db->select('sales_return.id, sales_return.no, sales_return.sales, sales_return.dates, sales_return.currency, sales_return.docno,
                           sales_return.user, sales_return.log, sales_return.cash,
                           sales_return.tax, sales_return.balance, sales_return.total, sales_return.notes,
