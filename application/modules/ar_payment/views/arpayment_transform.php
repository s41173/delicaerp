...
<script type="text/javascript">	
	...
	function set_amount_text()
	{
		...
		{ 
		  ...
		  document.getElementById("tdiscount").disabled = true; 
		}
		else 
		{ 
		  ...
		  document.getElementById("tdiscount").disabled = false;
		}
	}
...
<div id="webadmin">
	...
	<fieldset class="field" style="float:left; margin-left:15px;"> <legend> Check Details </legend>
		...
		<table>
			...
			<tr>	
			<td> <label for="cbank"> Account </label> </td> <td>:</td>
		...
		<table>
			<tr>
				...
				<td>
					...
					<input type="text" disabled="disabled" size="8" name="tamount" id="tamount" onKeyUp="checkdigit(this.value, 'tamount')" /> &nbsp;
				</td>
                
                <td>
					<label for="ttax"> Tax : </label> <br />
					<input type="text" disabled="disabled" size="8" name="ttax" id="ttax" onKeyUp="checkdigit(this.value, 'ttax')" /> &nbsp;
				</td>
                
                <td>
					<label for="ttax"> Discount : </label> <br />
					<input type="text" disabled="disabled" size="8" name="tdiscount" id="tdiscount" onKeyUp="checkdigit(this.value, 'tdiscount')" /> &nbsp;
				</td>
                
                <td>
					<label for="ttax"> Cost : </label> <br />
					<input type="text" disabled="disabled" size="8" name="tcost" id="tcost" onKeyUp="checkdigit(this.value, 'tcost')" /> &nbsp;
				</td>
                
                <td>
					<label for="ttax2"> Other Tax : </label> <br />
					<input type="text" disabled="disabled" size="8" name="ttax2" id="ttax2" onKeyUp="checkdigit(this.value, 'ttax2')" /> &nbsp;
				</td>
                
                <td>
					<label for="tnotes"> Notes : </label> <br />
					<textarea name="tnotes" cols="28" rows="1"></textarea>
				</td>
