...
class Arpayment_model extends CI_Model
{
    ...
    function get_last($limit, $offset)
    {
        $this->db->select('ar_payment.id, ar_payment.no, ar_payment.check_no, ar_payment.dates, customer.prefix, customer.name, ar_payment.user,
                           ar_payment.amount, ar_payment.acc, ar_payment.currency, ar_payment.approved');
    ...
    {
        $this->db->select('ar_payment.id, ar_payment.no, ar_payment.docno, ar_payment.check_no, ar_payment.account, ar_payment.due,
    ...
    {
        $this->db->select('ar_payment.id, ar_payment.no, ar_payment.docno, ar_payment.check_no, ar_payment.account, ar_payment.due, ar_payment.customer,
                           ar_payment.dates, customer.prefix, customer.name, ar_payment.user,
                           ar_payment.amount, ar_payment.acc, ar_payment.currency, ar_payment.approved');
