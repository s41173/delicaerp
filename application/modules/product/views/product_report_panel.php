...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>" target="_blank" onsubmit="" >
            ...
            <tr>	
			<td> <label for="cbrand"> Warehouse </label> </td> <td>:</td>
			...
			<td> <select name="ctype"> 
                 ...
                 <option value="4"> Inventory Label Report </option>
                 <option value="2"> Inventory - Pivottable </option> 
                 <option value="1"> Stock Card </option>
                 <option value="3"> Label Report </option> </select> <br /> </td>
			</tr>			
