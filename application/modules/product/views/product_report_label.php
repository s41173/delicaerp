        ...
        $(document).ready(function () {
            ...
            $("#jqxgrid").jqxGrid(
            {
                ...
                columns: [
				  ...
				  { text: 'Label', datafield: 'Label', width: 70, cellsalign: 'center' }
...
<div style="width:100%; border:0px solid blue; font-family:Arial, Helvetica, sans-serif; font-size:12px;">
	...
	<center>
	   <div style="border:0px solid green; width:230px;">
	       <h4> <?php echo isset($company) ? $company : ''; ?> <br> Inventory Report - Label </h4>
	   </div>
	</center>
			...
			//		$sum = $pro->get_sum_stock($pid); unit cost lama
				...
				foreach ($reports as $res)
				{
				   ...
				   $image_properties = array(
							  'src' => site_url('product').'/set_barcode/PRO-0'.$res->id,
							  'alt' => $res->name,
							  'class' => '',
							  'width' => '140',
							  'height' => '60',
				   ...
				   <tr>
					   ...
					   <td class=\"strongs\"> PRO-0".$res->id."</td>
