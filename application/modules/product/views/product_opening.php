...
<div id="webadmin2">
	...
	<form name="search_form" class="myform" id="ajaxform" method="post" action="<?php echo ! empty($form_action_del) ? $form_action_del : ''; ?>">
     ...
     <table>
<tr> <td> <label> Qty : </label> &nbsp; </td> <td> <input class="" type="text" name="tqty" size="5" readonly="readonly" value="<?php echo intval($openqty); ?>" /> </td> </tr>
<tr> <td> <label> Balance : </label> &nbsp; </td> <td> <input class="" type="text" name="tbalance" size="13" readonly="readonly" value="<?php echo intval($openbalance); ?>" /> </td> </tr>
