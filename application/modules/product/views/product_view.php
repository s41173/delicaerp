...
<div id="webadmin">
	...
	<form name="modul_form" class="myform" id="form" method="post" action="<?php echo $form_action; ?>">
				<table>
                    ...
                    <td> <label for="ctsku"> SKU : PRO-0 </label> <br />
										<select name="cbarcode"> <option value="0"> Barcode </option> <option value="1"> Key </option> </select>
										<input type="text" name="tsku" id="tsku" title="SKU" size="15" autofocus /> &nbsp;
                    </td>
                    ...
                    <td> <label for="ccategory"> Storage : </label> <br />
		            <?php $js = 'class=""'; echo form_dropdown('cstorage', $warehouse, isset($default['warehouse']) ? $default['warehouse'] : '', $js); ?> &nbsp;                    </td>
                    ...
                    <td colspan="2"> <label for="tname"> Vendor : </label> <br />
					    <input type="text" readonly="readonly" name="tvendor" id="tcust" size="32" title="Customer" />
				<!--		<a class="refresh" id="tombol" href="<?php //echo site_url("vendor/get_list/"); ?>"> [ ... ] </a> -->
                    ...
                    <td colspan="4"> Name ( Keyword ) : &nbsp; <br />
					    <input type="text" name="tsearch" size="40" id="tproductsearch" />
...
<div id="webadmin2">
	...
	<tbody>
		<tr>
           ...
           <?php echo anchor(site_url("product/calculate_qty"), 'CALCULATE', $atts2); ?>
		   </td>
		</tr>
	</tbody>
	</table>
